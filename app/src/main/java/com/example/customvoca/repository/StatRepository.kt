...
class StatRepository {
    suspend fun getStats(vocabId: Int): ApiResponse<List<StatDto>> {
        val response = RetrofitInstance.statApi.getStats(vocabId)
    ...
    suspend fun getStatDetail(wordId: Int): ApiResponse<StatDto>{
        val response = RetrofitInstance.statApi.getStatDetail(wordId)
    ...
    suspend fun getLearningRate(vocabId: Int): ApiResponse<Double>{
        val response = RetrofitInstance.statApi.getLearningRate(vocabId)
    ...
    suspend fun getDiff(wordId: Int): ApiResponse<Double>{
        val response = RetrofitInstance.statApi.getDiff(wordId)
